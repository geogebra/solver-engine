module.exports = {
  branches: [
    ...
    'release',
    // release new SDK package with @beta tag when on "staging" branch and add the "-staging.x"
    // suffix to version
    { name: 'staging', channel: 'beta', prerelease: 'staging' },
    // release new SDK package with @alpha tag when on "main" branch and add the "-main.x"
    // suffix to version
    { name: 'main', channel: 'alpha', prerelease: 'main' },
