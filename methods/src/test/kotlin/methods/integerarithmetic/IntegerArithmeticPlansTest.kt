...
class IntegerArithmeticPlansTest {
    @Test
    fun testSimplifyArithmeticExpressionSimple() =
        testMethod {
    ...
    @Test
    fun testSimplifyArithmeticExpressionPowerSmall() =
        testMethod {
            method = IntegerArithmeticPlans.EvaluateArithmeticExpression
            inputExpr = "[2 ^ 4]"
    ...
    @Test
    fun testSimplifyArithmeticExpressionPowerLarge() =
        testMethod {
            method = IntegerArithmeticPlans.EvaluateArithmeticExpression
            inputExpr = "[2 ^ 6]"
    ...
    @Test
    fun `test 1 plus negative 2 without adding clarifying brackets`() =
        testMethod {
            method = IntegerArithmeticPlans.EvaluateArithmeticExpression
    ...
    @Test
    fun testSimplifyArithmeticExpressionAddMultiplyDivide() =
        testMethod {
            method = IntegerArithmeticPlans.EvaluateArithmeticExpression
    ...
    @Test
    fun testSimplifyArithmeticExpressionBracketsAndNegativeMultiply() =
        testMethod {
            method = IntegerArithmeticPlans.EvaluateArithmeticExpression
    ...
    @Test
    fun testEvaluateArithmeticExpressionPowerAndBrackets() =
        testMethod {
            method = IntegerArithmeticPlans.EvaluateArithmeticExpression
            inputExpr = "[(1 + 1) ^ [2 ^ 3]]"
    ...
    @Test
    fun testEvaluateSignedIntegerPowerPlan() =
        testMethod {
            method = IntegerArithmeticPlans.EvaluateArithmeticExpression
            inputExpr = "[4^2]"
    ...
    @Test
    fun testEvaluateSignedIntegerPower1() =
        testMethod {
            method = IntegerArithmeticPlans.EvaluateArithmeticExpression
            inputExpr = "[2 ^ 6]"
    ...
    @Test
    fun testEvaluateSignedIntegerPower2() =
        testMethod {
            method = IntegerArithmeticPlans.EvaluateArithmeticExpression
            inputExpr = "[2^5]"
    ...
    @Test
    fun testNoTransformationNonDivisible() =
        testMethod {
            method = IntegerArithmeticPlans.EvaluateArithmeticExpression
            inputExpr = "5 + 6*3:5"
