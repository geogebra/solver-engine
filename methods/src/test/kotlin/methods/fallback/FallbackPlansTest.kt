...
class FallbackPlansTest {
    ...
    @Test
    fun testExpressionIsFullySimplifiedSucceedsWithLinearPolynomial() = testMethod {
    ...
    @Test
    fun testExpressionIsFullySimplifiedFailsWithQuadratic() = testMethod {
        method = FallbackPlans.ExpressionIsFullySimplified
        inputExpr = "[x^2] + 2x"
    ...
    @Test
    fun testQuadraticHasNegativeDiscriminantSucceeds() = testMethod {
        method = FallbackPlans.QuadraticHasNegativeDiscriminant
        inputExpr = "[x ^ 2] + 2 x + 2"
    ...
    @Test
    fun testQuadraticHasNegativeDiscriminantFails() = testMethod {
        method = FallbackPlans.QuadraticHasNegativeDiscriminant
        inputExpr = "[x^2] - 3x + 2"
