...
class AlgebraicSimplificationsTest {
    @Test
    fun `test product of fractions and non-fractional terms`() =
        testMethod {
    ...
    @Test
    fun `test dividing rational expressions`() =
        testMethod {
            method = SimplifyPlans.SimplifyAlgebraicExpression
    ...
    @Test
    fun `test simplifying before multiplying of rational expressions`() =
        testMethod {
            method = SimplifyPlans.SimplifyAlgebraicExpression
    ...
    @Test
    fun `test simplifying algebraic expression containing additions and divisions`() =
        testMethod {
            method = SimplifyPlans.SimplifyAlgebraicExpression
    ...
    @Test
    fun `test simplify algebraic expression with common factor`() =
        testMethod {
            method = SimplifyPlans.SimplifyAlgebraicExpression
    ...
    @Test
    fun `test cancel two multiple after extracting -ve`() =
        testMethod {
            method = SimplifyPlans.SimplifyAlgebraicExpression
    ...
    @Test
    fun `test cancellation of one factor even after possible minus extraction`() =
        testMethod {
            method = SimplifyPlans.SimplifyAlgebraicExpression
...
class AlgebraicExpressionContainingAbsoluteValue {
    @Test
    fun `test simplify even power of absoluteValue`() =
        testMethod {
            method = SimplifyPlans.SimplifyAlgebraicExpression
            inputExpr = "[abs[y]^2]"
    ...
    @Test
    fun `test simplify cancellable root of power to even power`() =
        testMethod {
            method = SimplifyPlans.SimplifyAlgebraicExpression
    ...
    @Test
    fun `test simplify cancellable root of power to power of absolute value`() =
        testMethod {
            method = SimplifyPlans.SimplifyAlgebraicExpression
    ...
    @Test
    fun `test simplify polynomial with fraction coefficients`() =
        testMethod {
            method = SimplifyPlans.SimplifyAlgebraicExpression
            context = Context(
                settings = mapOf(
                    Setting.RestrictAddingFractionsWithConstantDenominator setTo BooleanSetting.True,
                ),
            )
