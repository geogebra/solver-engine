...
class ApproximationPlansTest {
    @Test
    fun testRoundingTerminatingDecimals() =
        testMethod {
    ...
    @Test
    fun testRoundingRecurringDecimals() =
        testMethod {
            method = ApproximationPlans.ApproximateExpression
    ...
    @Test
    fun testNumericEvaluationWithHigherPrecision() =
        testMethod {
    ...
    @Test
    fun testNumericEvaluationFailsForInteger() =
        testMethod {
            method = ApproximationPlans.EvaluateExpressionNumerically
            inputExpr = "42"
    ...
    @Test
    fun testNumericEvaluationFailsForDecimal() =
        testMethod {
            method = ApproximationPlans.EvaluateExpressionNumerically
            inputExpr = "3.14"
    ...
    @Test
    fun testNumericEvaluationFailsForNegativeDecimal() =
        testMethod {
            method = ApproximationPlans.EvaluateExpressionNumerically
            inputExpr = "-3.14"
