...
class SimpleFractionsTest {
    ...
    @Test
    fun testWithNegativesInFractions() =
        testMethod {
            method = ConstantExpressionsPlans.SimplifyConstantExpression
            inputExpr = "[-1 / 6] * [2 / -5]"
    ...
    @Test
    fun testWithMoreNegativesInFractions() =
        testMethod {
            method = ConstantExpressionsPlans.SimplifyConstantExpression
...
class AddingFractionsTest {
    ...
    @Test
    fun testSimplifyFractionsBeforeAdding() =
        testMethod {
            method = ConstantExpressionsPlans.SimplifyConstantExpression
    ...
    @Test
    fun testAddingFractionWithoutUnnecessaryCanceling() =
        testMethod {
            method = ConstantExpressionsPlans.SimplifyConstantExpression
    ...
    @Test
    fun `test adding integer to integer fraction`() =
        testMethod {
            method = ConstantExpressionsPlans.SimplifyConstantExpression
            inputExpr = "3 + [1 / 2]"
    ...
    @Test
    fun `test subtracting integer from fraction (match in the opposite order)`() =
        testMethod {
            method = ConstantExpressionsPlans.SimplifyConstantExpression
    ...
    @Test
    fun `test adding integer to fraction with no integer in its numerator fails`() =
        testMethod {
            method = ConstantExpressionsPlans.SimplifyConstantExpression
    ...
    @Test
    fun `test adding integer to fraction with integer and root in its numerator`() =
        testMethod {
            method = ConstantExpressionsPlans.SimplifyConstantExpression
    ...
    @Test
    fun `test adding root to integer fraction fails`() =
        testMethod {
            method = ConstantExpressionsPlans.SimplifyConstantExpression
    ...
    @Test
    fun `test adding root to fraction with different root in its numerator fails`() =
        testMethod {
            method = ConstantExpressionsPlans.SimplifyConstantExpression
    ...
    @Test
    fun `test adding root to fraction with the same root in its numerator`() =
        testMethod {
            method = ConstantExpressionsPlans.SimplifyConstantExpression
...
class ZeroNumeratorTest {
    ...
    @Test
    fun testDenominatorNotZeroBecauseOfIncommensurableTerms() =
        testMethod {
            method = ConstantExpressionsPlans.SimplifyConstantExpression
    ...
    @Test
    fun testDenominatorEventuallyNotZero() =
        testMethod {
            method = ConstantExpressionsPlans.SimplifyConstantExpression
            inputExpr = "[0 / 3 - 5]"
