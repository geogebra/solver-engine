...
class ExpandConstantExpressionsTest {
    ...
    @Test
    fun `test expanding single bracket with positive factor on the right`() = testMethod {
    ...
    @Test
    fun `test expanding single bracket with negative factor on the right`() = testMethod {
        method = ConstantExpressionsPlans.SimplifyConstantExpression
        inputExpr = "(1 + sqrt[2]) * (-2)"
    ...
    @Test
    fun `test expanding single bracket in negated product`() = testMethod {
        method = ConstantExpressionsPlans.SimplifyConstantExpression
        inputExpr = "(1 + sqrt[2]) * (-2)"
    ...
    @Test
    fun `test expanding single bracket with factors on both sides`() = testMethod {
        method = ConstantExpressionsPlans.SimplifyConstantExpression
