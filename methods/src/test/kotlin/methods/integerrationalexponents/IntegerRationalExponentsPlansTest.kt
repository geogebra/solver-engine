...
class SimplifyRationalExponents {
    @Test
    fun testSimplifyRationalExponentOnePrimeFactorToInt() =
        testMethod {
    ...
    @Test
    fun testSimplifyRationalExponentOnePrimeFactorToProductWithInt() =
        testMethod {
            method = IntegerRationalExponentsPlans.SimplifyRationalExponentOfInteger
            inputExpr = "[8 ^ [7 / 6] ]"
    ...
    @Test
    fun testSimplifyUsingFactoringBeforeComputingProduct() =
        testMethod {
    ...
    @Test
    fun testMultiplySameExponentPowersBeforeSimplification() =
        testMethod {
            method = ConstantExpressionsPlans.SimplifyConstantExpression
    ...
    @Test
    fun testSimplifyProductOfPowersWithNegatedExponent() =
        testMethod {
    ...
    @Test
    fun testSimplifyProductOfPowersWithInverseFractionBase() =
        testMethod {
    ...
    @Test
    fun testSimplifyProductOfPowersWithInverseBase() =
        testMethod {
    ...
    @Test
    fun `test power rule of exponents with one negative exponent`() =
        testMethod {
            method = IntegerRationalExponentsPlans.ApplyPowerRuleOfExponents
            inputExpr = "[([5 ^ 2]) ^ -[1/2]]"
    ...
    @Test
    fun testSimplifyFractionOfPowersWithSameBase() =
        testMethod {
    ...
    @Test
    fun testSimplifyFractionOfPowersWithSameExponent() =
        testMethod {
    ...
    @Test
    fun testSimplifyProductOfPowersWithSameBase() =
        testMethod {
    ...
    @Test
    fun testRationalExponentCoPrimeWithPowerOfPrimeFactorOfBase() =
        testMethod {
            method = IntegerRationalExponentsPlans.SimplifyRationalExponentOfInteger
            inputExpr = "[125 ^ [1 / 2]]"
...
class SimplifyRationalExponentsDontApply {
    @Test
    fun testDontSimplifyMultipleFactors() =
        testMethod {
            method = IntegerRationalExponentsPlans.SimplifyRationalExponentOfInteger
            inputExpr = "[480 ^ [1 / 6]]"
