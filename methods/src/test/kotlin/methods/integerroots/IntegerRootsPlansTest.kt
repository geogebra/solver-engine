...
class SimplifySquareRootWithASquareFactorRadicandTest {
    ...
    @Test
    fun testExpressionWithSquareCoefficient() = testMethod {
    ...
    @Test
    fun testExpressionWithACoefficientWithASquareFactor() = testMethod {
        method = IntegerRootsPlans.SimplifySquareRootWithASquareFactorRadicand
        inputExpr = "sqrt[50 z]"
    ...
    @Test
    fun testSumWithASquareFactor() = testMethod {
        method = IntegerRootsPlans.SimplifySquareRootWithASquareFactorRadicand
