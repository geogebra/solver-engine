...
class SimplifyIntegerRootTest {
    ...
    @Test
    fun `doesn't apply for irreducible root`() = testMethod {
    ...
    @Test
    fun `doesn't apply for smart-factorisable irreducible root`() = testMethod {
        method = IntegerRootsPlans.SimplifyIntegerRoot
    ...
    @Test
    fun `perfect square sqrt(49)`() = testMethod {
        method = IntegerRootsPlans.SimplifyIntegerRoot
        inputExpr = "sqrt[49]"
    ...
    @Test
    fun `perfect cube root(216, 3)`() = testMethod {
        method = IntegerRootsPlans.SimplifyIntegerRoot
    ...
    @Test
    fun `smart factorization sqrt(100)`() = testMethod {
        method = IntegerRootsPlans.SimplifyIntegerRoot
        inputExpr = "sqrt[100]"
    ...
    @Test
    fun `smart factorization sqrt(1000)`() = testMethod {
        method = IntegerRootsPlans.SimplifyIntegerRoot
        inputExpr = "sqrt[1000]"
    ...
    @Test
    fun `smart factorization root(10000, 3)`() = testMethod {
        method = IntegerRootsPlans.SimplifyIntegerRoot
    ...
    @Test
    fun `smart factorization root(1000000, 3)`() = testMethod {
        method = IntegerRootsPlans.SimplifyIntegerRoot
    ...
    @Test
    fun `smart factorization sqrt(144)`() = testMethod {
        method = IntegerRootsPlans.SimplifyIntegerRoot
        inputExpr = "sqrt[144]"
    ...
    @Test
    fun `smart factorization sqrt(8100)`() = testMethod {
        method = IntegerRootsPlans.SimplifyIntegerRoot
        inputExpr = "sqrt[8100]"
    ...
    @Test
    fun `smart factorization root(27000, 3)`() = testMethod {
        method = IntegerRootsPlans.SimplifyIntegerRoot
    ...
    @Test
    fun `smart factorization root(9, 4)`() = testMethod {
        method = IntegerRootsPlans.SimplifyIntegerRoot
        inputExpr = "root[9, 4]"
    ...
    @Test
    fun `factoring into multiple factors with the same power root(7776, 10)`() = testMethod {
        method = IntegerRootsPlans.SimplifyIntegerRoot
    ...
    @Test
    fun `factoring into multiple factors with different powers sqrt(113400)`() = testMethod {
        method = IntegerRootsPlans.SimplifyIntegerRoot
