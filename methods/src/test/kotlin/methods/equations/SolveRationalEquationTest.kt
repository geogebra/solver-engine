    ...
    fun `test one of the term is a squareRoot`() = testMethodInX {
        ...
        check {
            ...
            task {
                ...
                step {
                    fromExpr = "[12 / [x ^ 2] - 9] = sqrt[2] - [2 / x + 3]"
                    toExpr = "SetSolution[x: {[2 sqrt[2] - sqrt[152 + 48 sqrt[2]] / 4], [2 sqrt[2] + sqrt[152 + 48 sqrt[2]] / 4]}]"
                    explanation {
                        key = EquationsExplanation.SolveRationalEquation
                    }
                    ...
                    step {
                        fromExpr =
                            "x = [2 sqrt[2] + (-sqrt[76 + 24 sqrt[2]]) sqrt[2] / 4] OR x = [2 sqrt[2] + (sqrt[76 + 24 sqrt[2]]) sqrt[2] / 4]"
                        toExpr =
                            "SetSolution[x: {[2 sqrt[2] - sqrt[152 + 48 sqrt[2]] / 4], [2 sqrt[2] + sqrt[152 + 48 sqrt[2]] / 4]}]"
                        explanation {
                            key = EquationsExplanation.SolveEquationUnion
                        }
                    }
