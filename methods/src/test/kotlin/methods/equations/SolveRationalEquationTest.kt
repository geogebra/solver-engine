...
class SolveRationalEquationTest {
    @Test
    fun `test rational equation with one valid solution`() =
        testMethodInX {
    ...
    @Test
    fun `test rational equation with one valid solution without computing the domain`() =
        testMethodInX {
            method = EquationsPlans.SolveRationalEquation
            inputExpr = "[12 / [x ^ 2] - 9] = [8 x / x - 3] - [2 / x + 3]"
            context =
    ...
    @Test
    fun `test solve equation with rational expression on both the sides`() =
        testMethodInX {
            method = EquationsPlans.SolveRationalEquation
    ...
    @Test
    fun `test equation with rational expression on both the sides without computing the domain`() =
        testMethodInX {
            method = EquationsPlans.SolveRationalEquation
            inputExpr = "[x + 2 / x - 3] = [x / 3 x - 2]"
            context =
    ...
    @Test
    fun `test cancel numerator and denominators to reduce to quadratic equation`() =
        testMethodInX {
            method = EquationsPlans.SolveRationalEquation
    ...
    @Test
    fun `test lcd polynomial and number`() =
        testMethodInX {
            method = EquationsPlans.SolveRationalEquation
    ...
    @Test
    fun `test lcd of additive inverse polynomial`() =
        testMethodInX {
            method = EquationsPlans.SolveRationalEquation
    ...
    @Test
    fun `test same denominator in rational equation`() =
        testMethodInX {
            method = EquationsPlans.SolveRationalEquation
    ...
    @Test
    fun `test one of the term is a squareRoot`() =
        testMethodInX {
            method = EquationsPlans.SolveRationalEquation
    ...
    @Test
    fun `test simplify power of lhs of rational equation`() =
        testMethodInX {
            method = EquationsPlans.SolveRationalEquation
            inputExpr = "[([x / x + 1]) ^ 2] = 1"
    ...
    @Test
    fun `test solve p(x) over r(x) = q(x) over r(x)`() =
        testMethodInX {
            method = EquationsPlans.SolveRationalEquation
            inputExpr = "[2 x / x] = [4 / x]"
    ...
    @Test
    fun `test rational equation reducible to polynomial by expanding`() =
        testMethodInX {
