...
class RootsMethodStrategyTest {
    ...
    @Test
    fun testRootMethodsAppliesWhenBracketsCouldBeExpanded() =
        shortTest(
    ...
    @Test
    fun `test square equals negative quadratic equation`() =
        testRootsMethod {
    ...
    @Test
    fun `test square equals zero quadratic equation`() =
        testRootsMethod {
    ...
    @Test
    fun `test square equals positive number quadratic equation`() =
        testRootsMethod {
    ...
    @Test
    fun `test quadratic equation containing linear terms that can be eliminated`() =
        testRootsMethod {
    ...
    @Test
    fun `test quadratic equation containing linear terms that cannot be eliminated fails`() =
        testMethod {
            context = context.copy(solutionVariables = listOf("y"))
    ...
    @Test
    fun `test roots method followed by roots method`() =
        testRootsMethod {
            inputExpr = "[([x ^ 2] + 1) ^ 2] = 4"
    ...
    @Test
    fun `test roots method followed by quadratic formula`() =
        testRootsMethod {
