...
class RationalExpressionsPlansTest {
    @Test
    fun `test simplification of rational expression`() =
        testMethod {
    ...
    @Test
    fun `test addition of like rational expressions`() =
        testMethod {
    ...
    @Test
    fun `test addition of non-fractional term and rational expression`() =
        testMethod {
    ...
    @Test
    fun `test addition of term and fraction which is not a rational expression fails`() =
        testMethod {
            method = RationalExpressionsPlans.AddTermAndRationalExpression
            inputExpr = "2 x + [y / 2]"
    ...
    @Test
    fun `test addition of unlike rational expressions without factorization`() =
        testMethod {
    ...
    @Test
    fun `test addition of rational expressions with one term needing factorization`() =
        testMethod {
            method = RationalExpressionsPlans.AddRationalExpressions
    ...
    @Test
    fun `test power of rational expressions`() =
        testMethod {
    ...
    @Test
    fun `test division of polynomial by monomial`() =
        testMethod {
